        ...
        <div className="container my-5 py-5">
          <div className="row align-items-center g-5">
            ...
            <div className="col-lg-6 text-center text-lg-end overflow-hidden">
              <img className="img-fluid" src="/assests/img/hero.png" alt="" />
            </div>
          </div>
        </div>
      </div>
