  ...
  return (
    <Fragment>
        <div className="site-blocks-cover"
          style={{ backgroundImage: 'url("/assets/images/par.jpg")', filter:'blur(5px)' }}
        >
          ...
          <div className="container">
            ...
            <div className="row">
              ...
              <div className="col-sm-6 col-lg-4 text-center item mb-4">
                <a href="shop-single.html">
                  {" "}
                  <img src="/assets/images/product_02.png" alt="Image" />
                </a>
                <h3 className="text-dark">
              ...
              <div className="col-sm-6 col-lg-4 text-center item mb-4">
                <a href="shop-single.html">
                  {" "}
                  <img src="/assets/images/product_04.png" alt="Image" />
                </a>
                <h3 className="text-dark">
              ...
              <div className="col-sm-6 col-lg-4 text-center item mb-4">
                <a href="shop-single.html">
                  {" "}
                  <img src="/assets/images/product_05.png" alt="Image" />
                </a>
                <h3 className="text-dark">
              ...
              <div className="col-sm-6 col-lg-4 text-center item mb-4">
                ...
                <a href="shop-single.html">
                  {" "}
                  <img src="/assets/images/product_06.png" alt="Image" />
                </a>
                <h3 className="text-dark">
